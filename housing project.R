...
apply(all_data_train,2,function(x)sum(is.na(x)))
...
set.seed(123)
glimpse(all_data)
s=sample(1:nrow(all_data_train),0.75*nrow(all_data_train))
train_75=all_data_train[s,] #5652
test_25=all_data_train[-s,]  #1884
...
RMSE_test_25
212467/RMSE_test_25
PP_test_final=predict(LRf,newdata =all_data_test)
PP_test_final=round(PP_test_final,1)
class(PP_test_final)
write.csv(PP_test_final, "Aasif_Khan_part1_p2.csv")
